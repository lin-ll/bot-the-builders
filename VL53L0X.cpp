...
bool VL53L0X::init(int pi_handle, bool ioMode2v8) {
	pi = pi_handle;
...
void VL53L0X::writeRegister(uint8_t reg, uint8_t value) {
	int p = i2c_write_byte_data(pi, this->i2cFileDescriptor, reg, value);
...
void VL53L0X::writeRegister16Bit(uint8_t reg, uint16_t value) {
	...
	int p = i2c_write_word_data(pi, this->i2cFileDescriptor, reg, valueFixed);
...
int p = i2c_write_i2c_block_data(pi, this->i2cFileDescriptor, reg, (char *)buffer, 4);
	delete [] buffer;
...
void VL53L0X::writeRegisterMultiple(uint8_t reg, const uint8_t* source, uint8_t count) {
	...
	int p = i2c_write_i2c_block_data(pi, this->i2cFileDescriptor, reg, (char *)buffer, count);
	delete [] buffer;
...
uint8_t VL53L0X::readRegister(uint8_t reg) {
	int p = i2c_read_byte_data(pi, this->i2cFileDescriptor, reg);
	lastStatus = (p == -1 ? errno : 0);
...
uint16_t VL53L0X::readRegister16Bit(uint8_t reg) {
	int p = i2c_read_word_data(pi, this->i2cFileDescriptor, reg);
...
uint32_t VL53L0X::readRegister32Bit(uint8_t reg) {
	int* buffer = new int[4]();
	int p = i2c_read_i2c_block_data(pi, this->i2cFileDescriptor, reg, (char *)buffer, 4);
...
void VL53L0X::readRegisterMultiple(uint8_t reg, uint8_t* destination, uint8_t count) {
	int* buffer = new int[count]();
	int p = i2c_read_i2c_block_data(pi, this->i2cFileDescriptor, reg, (char *)buffer, count);
